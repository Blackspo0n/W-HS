...
public class GDI2MinichessController 
{
	...
	boolean humanPlaysWhite = false;
	boolean humanPlaysBlack = false;
	...
	public GDI2MinichessController(GDI2MinichessGUI gdi2MinichessGUI, boolean b, boolean c) {
		
		
		this.humanPlaysBlack = b;
		this.humanPlaysWhite = c;

		this.gui = gdi2MinichessGUI;
